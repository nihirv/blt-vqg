...
class GVTransformerEncoder(nn.Module):
    def __init__(self, embedding, latent_layer, latent_transformer, args):
        ...
        self.encoder = Encoder(args.emb_dim, args.hidden_dim, num_layers=args.enc_num_layers, num_heads=args.num_heads,
                               ...
                               filter_size=args.pwffn_dim, input_dropout=args.dropout, layer_dropout=args.dropout, attention_dropout=args.dropout, relu_dropout=args.dropout)
    ...
    def forward(self, context, response, image_features):
        ...
        if self.latent_transformer:
            z_kld_loss, z, priors, posteriors = self.latent_layer(
        ...
        return encoder_outputs, response_encoder_outputs, z_kld_loss, z, priors, posteriors, src_mask, res_mask
